class UsersController < ApplicationController
  ...
  def update
    ...
    if @user.update(first_name:params[:user][:first_name],
                    ...
                    mentor:params[:user][:mentor],
                    mentor_limit:params[:user][:mentor_limit],
                    mentor_times: @user.mentor_times_change(params[:user][:mentor_limit]),
                    primary_industry:params[:user][:primary_industry],
                    stage_of_career:params[:user][:stage_of_career],
                    mentor_industry:params[:user][:mentor_industry],
                    peer_industry:params[:user][:peer_industry],
                    current_goal:params[:user][:current_goal],
                    top_3_interests:params[:user][:top_3_interests] || [],
                    live_in_detroit:params[:user][:live_in_detroit],
